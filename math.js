...
let firstNumber=parseFloat(prompt('give is a any number'));
...
let lastNumber=parseFloat(prompt('give us any number again'));
console.log(typeof lastNumber);

let sum = firstNumber  +   lastNumber;
let sub = firstNumber - lastNumber;
let dev = firstNumber /  lastNumber;
let mult = firstNumber * lastNumber;

let summary  = `
  ${firstNumber} + ${lastNumber}  =  ${sum} <br>
  ${firstNumber} - ${lastNumber} = ${sub}  <br>
  ${firstNumber} / ${lastNumber} = ${dev}  <br>
  ${firstNumber} * ${lastNumber} =${mult} 
